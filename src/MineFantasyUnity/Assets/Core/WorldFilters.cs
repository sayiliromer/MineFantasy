...
namespace Core
{
    public static class WorldFilters
    {
        ...
        public const WorldSystemFilterFlags Client =
        ...
        public const WorldSystemFilterFlags ClientServer = WorldSystemFilterFlags.ClientSimulation |
                                                           WorldSystemFilterFlags.ServerSimulation |
                                                           WorldSystemFilterFlags.ThinClientSimulation;

        public const WorldSystemFilterFlags NoThinClientServer =
